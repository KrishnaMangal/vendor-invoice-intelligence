...
def main():
    ...
    results.append(evaluate_model(dt_model, "Decision Tree Regression", X_test, y_test))
    results.append(evaluate_model(rf_model, "Random Forest Regression", X_test, y_test))
